...
export function Modal({
  ...
  return (
    <div className="fixed inset-0 z-40 backdrop-blur-md flex justify-center items-start overflow-y-auto p-4 sm:pt-10 animate-fade" onClick={onCerrar}>
      <div
        className="w-full max-w-lg bg-white rounded-2xl shadow-2xl max-h-[92vh] overflow-y-auto animate-scale ring-1 ring-slate-200"
        onClick={(e) => e.stopPropagation()}
      >
        <div className="flex items-center justify-between border-b border-slate-100 px-5 py-3.5 sticky top-0 bg-white backdrop-blur z-10">
