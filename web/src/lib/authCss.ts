// Estilos compartidos de las pantallas de acceso (login / restablecer).
...
.au-ok{background:#e9f7ef;border:1px solid #b6e3c8;color:#15803d;border-radius:10px;padding:10px 12px;
  font-size:13px;margin-bottom:12px;text-align:left;line-height:1.45;}
...
.au-link{display:inline-block;margin-top:14px;font-size:13px;color:#e85420;background:none;border:none;
